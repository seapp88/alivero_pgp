...
<!--                </div>-->
            ...
            <div class="menu-grid">
                <router-link to="/get-products">
                    <div class="card card-body h-100 bg-primary">
                        <div class="menu-item">
                            <div class="icon">
